...
<div class="wrapper">
    ...
    <form action="newempregisterprocess.php" method="post" >
        ...
        <div class="flex">
            ...
            <!--full name field-->
                <div class="field-container">
                    ...
                    <input type="text" name="username"   pattern="^([a-zA-Z]{2,} ?)+$" id="full-name" placeholder="Your full name" required="required" />
            ...
            <div class="flex-item">
                ...
                <div class="field-container">
                    ...
                    <input type="tel" name="contact" pattern=[0-9]{10} id="contact-no" placeholder="Mobile number" required="required" />
                    <span class="error-messg"></span>
                </div>
                ...
                <div class="field-container">
                    ...
                    <input type="password" name="password" id="passkey" class="passkey" placeholder="Password" required="required" />
                ...
                <div class="field-container">
                    <label for="nid">National identity number: <span class="required">*</span></label>
                    <div class="passkey-box">
                    <input type="tel" name="nid" class="nid" id="nid" placeholder="National identity number" required="required" />
                    </div>
                    <span class="error-messg"></span>
                </div>
                ...
                <div class="field-container">
                    ...
                    <div class="passkey-box">
                    <input type="text" name="service" class="service" id="service" placeholder="Service" required="required" />
                    </div>
                    <span class="error-messg"></span>
                </div>
        ...
        <!--Submit button-->
        <div class="center"><input type="submit" value="submit" name="submit"></div>
    </form>
    </div>
